...
const PAGE_DESCRIPTION =
  "Структурированная база знаний «Пора в Аргентину»: путешествия, переезд, документы и легализация, деньги, жизнь в стране и личный опыт. Более 260 проверенных материалов с поиском и навигацией.";
