...
import { logAnalyticsEvent, type AnalyticsEventType } from "@/lib/analytics/events-server";
...
/** Controlled commercial + detail events (partner handoff stays unlabeled as paid). */
