...
type CarRentalBenefitsProps = {
  title: string;
  items: [string, string, string, string];
};

const ICONS = [MapPin, ShieldCheck, Wallet, Car] as const;
...
export default function CarRentalBenefits({ title, items }: CarRentalBenefitsProps) {
