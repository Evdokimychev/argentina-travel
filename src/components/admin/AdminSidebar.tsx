...
const NAV_ICONS: Partial<Record<AdminNavItemId, typeof LayoutGrid>> = {
  ...
  "modules-overview": Boxes,
  "ingestion-overview": DatabaseZap,
  "ingestion-sources": DatabaseZap,
  "ingestion-runs": ListRestart,
  "ingestion-moderation": BookCheck,
  "ingestion-prompts": Bot,
  "users-list": Users,
