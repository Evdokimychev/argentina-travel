...
/**
 * Reusable HTML story deck for long guides.
 *
 * Progressive enhancement: every slide is always in the DOM as a normal
 * stacked section (readable with CSS/JS disabled). Once mounted, JS shows
 * one slide at a time with Back/Next, dots, swipe and arrow keys.
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {slide.ctas.map((cta) => (
                        <Link
                          ...
                          href={cta.href}
                          className="inline-flex min-h-11 items-center rounded-full border border-gray-200 bg-white px-3.5 py-2 text-sm font-medium text-charcoal shadow-sm transition hover:border-sky/40 hover:text-sky"
                        >
                          {cta.label}
                        </Link>
                      ))}
