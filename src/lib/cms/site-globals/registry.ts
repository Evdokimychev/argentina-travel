...
export const SITE_GLOBAL_DEFINITIONS: SiteGlobalDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      {
        name: "showGeography",
        label: "Включить раздел «Регионы и места»",
        type: "checkbox",
        hint: "Главный переключатель географического раздела: меню, публичные страницы и sitemap.",
      },
      { name: "showDestinations", label: "Показывать регионы", type: "checkbox" },
      { name: "showPlaces", label: "Показывать места, коллекции и маршруты", type: "checkbox" },
      ...
      { name: "showForum", label: "Показывать форум", type: "checkbox" },
      { name: "showShop", label: "Показывать магазин", type: "checkbox" },
      { name: "showServices", label: "Показывать сервисы", type: "checkbox" },
      {
        name: "showJournal",
        label: "Включить блог и журнал",
        type: "checkbox",
        hint: "Отключает публичные страницы блога и удаляет их из меню и sitemap; материалы в CMS сохраняются.",
      },
