...
function buildSearchFallbackAnswer(
  ...
  return `По вашему вопросу мы нашли подходящие материалы:\n\n${list}\n\nОткройте ссылки ниже — там есть подробности. Если вопрос касается виз или иммиграции, сверяйтесь с официальными правилами перед поездкой.`;
}
