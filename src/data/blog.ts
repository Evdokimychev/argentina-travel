...
export const blogPosts: BlogPost[] = [
  {
    ...
    authorBio: "Гид по Patagonia, 8 лет в туризме",
    date: "2025-05-15",
    image:
  ...
  },
  {
    ...
    content:
      "Asado — не просто барбекю, а целый ритуал. Традиционно готовят на parrilla (гриле) разные отрубы: bife de chorizo (рибай), ojo de bife, vacío (фlanк). Лучшие parrilla Буэнос-Айреса: Don Julio, La Cabrera, El Pobre Luis. Не забудьте chimichurri — соус из петрушки, чеснока и оливкового масла. Раздел путеводителя о кухне дополняет этот материал рекомендациями по вину и регионам.",
  ...
  },
  {
    ...
    excerpt:
      "Palermo, Recoleta, San Telmo и другие — краткий гид для выбора жилья и маршрутов.",
    content:
