...
export const PLACES_KB_IMPORT: KbImportPlace[] = [
  {
    ...
    fullDescription: "Окунитесь в экстремальное приключение рядом с горным хребтом в аргентинских Андах.\n\nПровинциальный парк Кордон-дель-Плата — одна из достопримечательностей региона Куйо (Мендоса). Материал подготовлен на основе официального портала INPROTUR (Argentina.travel) и адаптирован для путеводителя «Пора в Аргентину».",
