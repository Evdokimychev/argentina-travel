...
export const PLACE_ENRICHMENTS: Record<string, PlaceEnrichment> = {
  ...
  cafayate: {
    ...
    interestingFacts: [
      ...
      "В городе делают необычное вино-мороженое (helado de vino) из Torrontés и Cabernet.",
    ],
    howToGetThere:
  ...
  tilcara: {
    history:
      "Над Tilcara возвышается Pucará de Tilcara — укреплённое поселение народа омагуака, существовавшее задолго до прихода инков и испанцев. В начале XX века крепость частично восстановили исследователи из Университета Буэнос-Айреса; сегодня это археологический памятник с музеем.",
    interestingFacts: [
      "Pucará стоит на холме над долиной и контролировал древний караванный путь по Quebrada de Humahuaca.",
      "В Tilcara сильны андские традиции: карнавал и праздник Pachamama (август) с обрядами благодарения земле.",
      "Рядом — узкое ущелье Garganta del Diablo с короткой тропой от посёлка.",
    ],
    howToGetThere:
      "Из Сальты — около 2,5–3 ч на автобусе или авто по RN9 через Jujuy; из города Сан-Сальвадор-де-Жужуй — примерно 1,5 ч. Tilcara часто совмещают с Purmamarca и Humahuaca в одном маршруте по долине.",
    nearbyHighlights: [
      "Purmamarca и Cerro de los Siete Colores",
      "Humahuaca и обзорная точка Hornocal",
      "Salinas Grandes — соляной марш на алтиплано",
    ],
    faq: [
      {
        question: "Нужен ли отдельный день на Tilcara?",
        answer:
          "Pucará и музей занимают несколько часов; многие осматривают Tilcara в рамках дневной поездки по Quebrada de Humahuaca, но ночёвка позволяет увидеть посёлок без толп.",
      },
    ],
  },
  "quebrada-de-humahuaca": {
    history:
      "Quebrada de Humahuaca тысячелетиями служила путём сообщения между Андами и низменностями — здесь проходили караваны, а позже Камино-Реаль испанской короны. В 2003 году долина внесена в список Всемирного наследия ЮНЕСКО как культурный ландшафт, сочетающий природу и многовековую историю заселения.",
    interestingFacts: [
      "Длина долины — около 155 км вдоль реки Рио-Гранде, с посёлками Purmamarca, Tilcara и Humahuaca.",
      "Над городом Humahuaca находится обзорная точка Hornocal — «гора 14 цветов» с зубчатым разноцветным гребнем.",
      "Минеральные слои окрашивают склоны в красные, охристые и зеленоватые тона.",
    ],
    howToGetThere:
      "Долина тянется вдоль RN9 на север от Сан-Сальвадор-де-Жужуй и Сальты. Удобнее с арендой авто или на экскурсии: за день можно охватить Purmamarca, Tilcara и Humahuaca, но на Hornocal и Salinas Grandes лучше заложить дополнительное время.",
    nearbyHighlights: [
      "Purmamarca и Cerro de los Siete Colores",
      "Tilcara и Pucará",
      "Hornocal — гора 14 цветов у Humahuaca",
    ],
    faq: [
      {
        question: "Сколько времени нужно на долину?",
        answer:
          "Минимум один полный день для основных посёлков; 2–3 дня — чтобы добавить Hornocal, Salinas Grandes и спокойно пройти тропы.",
      },
      {
        question: "Нужна ли акклиматизация?",
        answer:
          "Посёлки долины лежат на 2000–3000 м, а Salinas Grandes и перевалы — выше 4000 м. При выездах на большую высоту полезно двигаться постепенно и пить больше воды.",
      },
    ],
  },
  "salinas-grandes": {
    history:
      "Salinas Grandes — реликтовое соляное озеро, образовавшееся при высыхании древних водоёмов на алтиплано. Соль здесь добывают традиционным способом, вырезая блоки из корки; добыча соседствует с растущим туристическим интересом к сюрреалистичным белым пейзажам.",
    interestingFacts: [
      "Марш лежит на высоте около 3450 м на границе провинций Жужуй и Сальта.",
      "Геометрические «бассейны» (piletas) на поверхности — следы выпаривания и добычи соли.",
      "Дорога из Purmamarca поднимается через перевал Abra de Lipán на высоту порядка 4170 м.",
    ],
    howToGetThere:
      "Чаще всего едут из Purmamarca по RN52 (около 1,5–2 ч с подъёмом на перевал) — на авто или с экскурсией. На высоте возможна горная болезнь, поэтому полезна предварительная акклиматизация в долине.",
    nearbyHighlights: [
      "Purmamarca и Cuesta de Lipán",
      "Quebrada de Humahuaca",
      "Posadas de altura и андские деревни по дороге",
    ],
    faq: [
      {
        question: "Когда лучше ехать?",
        answer:
          "Сухой сезон (апрель–ноябрь) — больше шансов на ровную сухую корку и ясное небо. В сезон дождей поверхность может быть залита водой.",
      },
    ],
  },
  "san-martin-de-los-andes": {
    history:
      "Город основан в 1898 году как пограничный форпост у озера Лакар. Со временем San Martín de los Andes превратился в курорт с архитектурой в альпийском стиле и стал воротами национального парка Lanín и северного участка Дороги семи озёр.",
    interestingFacts: [
      "Это северная отправная точка живописной Ruta de los Siete Lagos до Виллы-Ла-Ангостуры.",
      "Над городом — горнолыжный центр Chapelco, работающий зимой (июнь–сентябрь).",
      "Вулкан Lanín (3776 м) в одноимённом парке виден из окрестностей в ясную погоду.",
    ],
    howToGetThere:
      "Аэропорт Chapelco (CPC) между San Martín и Junín de los Andes; также рейсы в Bariloche (BRC) и далее по Ruta 40 / Дороге семи озёр (около 4 ч с остановками). Автобусы связывают город с Bariloche и Neuquén.",
    nearbyHighlights: [
      "Дорога семи озёр до Виллы-Ла-Ангостуры",
      "Национальный парк Lanín и вулкан Lanín",
      "Озеро Лакар и пляж Quila Quina",
    ],
    faq: [
      {
        question: "San Martín или Bariloche?",
        answer:
          "San Martín тише и зеленее, ближе к парку Lanín; Bariloche крупнее, с большей инфраструктурой и рейсами. Их удобно совместить через Дорогу семи озёр.",
      },
    ],
  },
  "villa-la-angostura": {
    history:
      "Villa La Angostura выросла в XX веке как тихий дачный и туристический посёлок на северном берегу Науэль-Уапи. Название связано с узким перешейком (angostura), ведущим к полуострову Кетриуэ, где находится знаменитый лес араянов.",
    interestingFacts: [
      "Национальный парк Los Arrayanes охраняет редкий лес миртовых деревьев (arrayanes) с корицево-рыжей корой.",
      "Посёлок — южная точка Дороги семи озёр со стороны Bariloche.",
      "Зимой рядом работает горнолыжный центр Cerro Bayo.",
    ],
    howToGetThere:
      "Из Bariloche — около 80 км (1–1,5 ч) по RN40 вдоль озера; регулярные автобусы и трансферы. До леса араянов — пешая или велосипедная тропа по полуострову либо прогулочный катер.",
    nearbyHighlights: [
      "Национальный парк Los Arrayanes",
      "Дорога семи озёр до Сан-Мартина-де-лос-Андес",
      "Bariloche и озеро Науэль-Уапи",
    ],
    faq: [
      {
        question: "Как добраться до леса араянов?",
        answer:
          "Пешком или на велосипеде по тропе полуострова Кетриуэ (около 12 км в одну сторону) либо на катере от пристани; вход — по тарифам национального парка.",
      },
    ],
  },
};
