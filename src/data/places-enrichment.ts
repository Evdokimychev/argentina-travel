...
export const PLACE_ENRICHMENTS: Record<string, PlaceEnrichment> = {
  ...
  "iguazu-falls": {
    history:
      "Водопады известны коренным народам guaraní как «большая вода» (Iguazú). Европейский мир узнал о них благодаря экспедиции Álvar Núñez Cabeza de Vaca — Кабеса де Вака, 1542 год (он назвал их Saltos de Santa María); массовый туризм начался после создания национальных парков в XX веке. С 1984 года аргентинская часть — объект UNESCO.",
    interestingFacts: [
    ...
    howToGetThere:
      "Аэропорт IGR (Puerto Iguazú) — рейсы из Buenos Aires (AEP/EZE). Из города — автобус или такси до парка (~20 км). Маршрут «нижние + верхние тропы + поезд к Garganta del Diablo» занимает полный день. Бразильская сторона (Foz) — отдельный въезд; виза гражданам РФ не нужна (безвиз до 90 дней), нужен загранпаспорт.",
    nearbyHighlights: [
    ...
    faq: [
      {
        ...
        answer:
          "Аргентинская — больше троп и близкий контакт с водой; бразильская — панорама всего комплекса. Идеально посетить обе: для граждан РФ виза в Бразилию не нужна (безвиз до 90 дней), возьмите загранпаспорт.",
      },
      {
    ...
    faq: [
      {
        ...
        answer: "Да — chocolate tours, brewery, spa; но основной зимний draw — лыжи и сноуборд на Catedral.",
      },
    ],
  },
  mendoza: {
