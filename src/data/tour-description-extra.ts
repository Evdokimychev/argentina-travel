...
const patagoniaExtra: TourDescriptionExtra = {
  ...
  transfers:
    "Все трансферы по программе включены: аэропорт → отель, между городами, в национальные парки. Групповой микроавтобус или минivan, место встречи — аэропорт Ezeiza с табличкой ArgentinaTravel.",
};
