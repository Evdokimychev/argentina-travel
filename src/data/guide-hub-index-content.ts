...
const FAQ: GuideIndexHubContent["faq"] = [
  ...
  },
  {
    ...
    answer:
      "Да — на момент публикации требуется для туристического въезда (Decreto 366/2025). Полис или страховая помощь путешественникам (travel assistance) с покрытием на всей территории Аргентины на весь заявленный срок. Для активных туров в Патагонии — расширенное покрытие. Требования уточняйте перед вылетом.",
  },
  {
