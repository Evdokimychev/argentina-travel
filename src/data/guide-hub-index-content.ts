...
const FAQ: GuideIndexHubContent["faq"] = [
  ...
  },
  {
    ...
    answer:
      "При базовой осмотрительности — да. Основной риск в BA — карманники; в туристических районах днём спокойнее. На тропах — погода и подготовка. См. тему «Безопасность» и PDF-гид по BA.",
  },
  {
...
export const GUIDE_HUB: GuideIndexHubContent = {
  ...
  quickFacts30: [
    { emoji: "🌎", label: "Масштаб", value: "8 туристических регионов" },
    { emoji: "📚", label: "Темы", value: "14 разделов путеводителя" },
    { emoji: "✈️", label: "Въезд", value: "Безвиз до 90 дней (РФ)" },
    { emoji: "☀️", label: "Патагония", value: "Сезон: ноябрь–март" },
    { emoji: "💵", label: "Деньги", value: "Peso, USD и «синий» курс" },
    { emoji: "🎫", label: "Туры", value: "Авторские маршруты на платформе" },
  ],
  toc: [
  ...
  planning: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Курсы peso, карты, обмен USD. Туры на платформе — прозрачные цены в USD для сравнения.",
