...
export const IMMIGRATION_PROCESS: ImmigrationProcessContent = {
  ...
  dnuNote:
    "Проверено 21.08.2026 по официальному тексту Decreto 366/2025. До поездки повторно проверьте, появился ли регламент статьи 123 bis.",
  radexSteps: [
...
export const IMMIGRATION_CITIZENSHIP: ImmigrationCitizenshipContent = {
  ...
  note:
    "Проверено 21.08.2026 по Ley 346, Decreto 366/2025 и сообщению DNM от 06.10.2025. Материал справочный и не заменяет консультацию по конкретному делу.",
};
...
export const IMMIGRATION_RESIDENCY: ImmigrationResidencyContent = {
  ...
  dnuWarning:
    "Decreto 366/2025 изменил precaria, семейное воссоединение, постоянное проживание и правила отмены статуса. Проверено 21.08.2026; перед подачей откройте актуальную карточку trámite DNM.",
  types: [
  ...
  note: "Проверено 21.08.2026 по Ley 25.871, Decreto 366/2025 и официальным страницам DNM. Это справочный материал, а не решение по конкретному делу.",
};
