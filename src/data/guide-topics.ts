...
export const GUIDE_INDEX_INTRO =
  "Главные темы для поездки в Аргентину: практические советы, партнёрские сервисы и подборки туров. Каждый раздел — отправная точка перед бронированием на платформе.";
