...
export const PROVINCE_LABELS_RU: Record<string, { nameRu: string; macroRegionRu: string }> = {
  ...
  "AR-N": { nameRu: "Провинция Мисьонес", macroRegionRu: "Северо-Восток" },
  "AR-W": { nameRu: "Провинция Корриентес", macroRegionRu: "Северо-Восток" },
  "AR-H": { nameRu: "Провинция Чако", macroRegionRu: "Северо-Восток" },
  "AR-P": { nameRu: "Провинция Формоса", macroRegionRu: "Северо-Восток" },
