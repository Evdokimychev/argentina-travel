...
export const SEARCH_DESTINATIONS = [
  {
    ...
    keywords: ["argentina", "аргентина", "аргент"],
  },
  {
    label: "Буэнос-Айрес",
    type: "city",
  ...
  },
  {
    ...
    description: "Один из самых южных городов мира и канал Бигля",
...
const POPULAR_DESTINATIONS_BASE = [
  ...
  },
  {
    ...
    name: "Барилоче",
    region: "Патагония",
    description: "Озеро Науэль-Уапи, гора Серро-Катедраль и знаменитые шоколадные мастерские",
  ...
  },
  {
    ...
    name: "Пуэрто-Игуасу",
    region: "Мисионес",
    description: "Около 275 водопадов и Гарганта-дель-Дьябло — объект Всемирного наследия ЮНЕСКО",
  ...
  },
  {
    ...
    name: "Сальта",
    region: "Северо-Запад",
    description: "Кафаяте, винные долины и колониальный центр; рядом — Кебрада-де-Умауака (Жужуй)",
