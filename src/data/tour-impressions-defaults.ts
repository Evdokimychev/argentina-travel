...
export const DEFAULT_IGUAZU_IMPRESSIONS: TourPlace[] = [
  {
    ...
    description:
      "Самая знаменитая точка парка — «Дьявол's Throat». Шум воды слышен за километр, брызги создают радуги, а панорама из 280 каскадов оставляет сильное впечатление.",
