...
export const DEFAULT_IGUAZU_IMPRESSIONS: TourPlace[] = [
  {
    ...
    description:
      "Самая знаменитая точка парка — «Дьявол's Throat». Шум воды слышен за километр, брызги создают радуги, а панорама из около 275 каскадов оставляет сильное впечатление.",
  ...
  },
  {
    ...
    description:
      "Поезд проносит вас сквозь тропический лес Атлантики к началу пешего маршрута. По пути можно увидеть бабуинов, туканов и редкие виды орхидей.",
