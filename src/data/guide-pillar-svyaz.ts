  ...
  sections: [
    {
      ...
      infoBoxes: [
        ...
        },
        {
          ...
          body:
            "Конкретные суммы в песо быстро устаревают. Сверяйте стоимость пакета на месте и учитывайте курс и комиссию выбранного официального способа оплаты.",
        },
      ],
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          body:
            "Роуминг удобен в первые часы, но для длительной поездки сравните его итоговую стоимость с актуальными пакетами местных операторов. Оставьте основную линию для банковских SMS и 2FA, а передачу данных настройте осознанно, чтобы избежать фоновых списаний.",
        },
        {
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          body:
            "SIM и пополнение оплачиваются в песо. Сверяйте стоимость в /guide/ekonomika-i-dengi; доллары в киосках принимают не всегда, поэтому заранее подготовьте небольшую сумму в песо.",
        },
        {
