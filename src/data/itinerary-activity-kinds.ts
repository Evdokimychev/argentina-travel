...
export const ITINERARY_ACTIVITY_KINDS: ItineraryActivityKindOption[] = [
  ...
  { kind: "atv", label: "Квадроцикл / ATV", icon: Zap, keywords: ["atv", "квадро", "quad"] },
  ...
  { kind: "wildlife_drive", label: "Сафари на авто", icon: Binoculars, keywords: ["safari drive", "game drive"] },
