...
export const GUIDE_ABOUT_ARGENTINA: GuideAboutArgentinaContent = {
  ...
  quickFacts: [
    ...
    { emoji: "💵", label: "Валюта", headline: "Песо (ARS)", detail: "См. «Экономика и деньги»" },
  ...
  whyVisit: {
    ...
    bullets: [
      ...
      "Патагония и Los Glaciares — обязательны для любителей треккинга и экспедиций",
  ...
  regions: [
    ...
    },
    {
      ...
      title: "Iguazú",
      days: "2–3 дня",
      summary: "Около 275 водопадов (ЮНЕСКО), аргентинская и бразильская стороны, джунгли Мисьонес.",
  ...
  practicalCards: [
    ...
    },
    {
      emoji: "💵",
      title: "Деньги и курс",
      body: "Песо, карты и обмен USD. Курс и правила меняются — проверяйте актуальную ситуацию перед поездкой.",
