...
export const GUIDE_ABOUT_ARGENTINA: GuideAboutArgentinaContent = {
  ...
  intro:
    "Аргентина — восьмая по площади страна мира и один из самых контрастных маршрутов Южной Америки: от тропических водопадов Иguazú на севере до ледников Patagonia и «края света» в Ushuaia. Столица Buenos Aires — отдельный мир с европейской архитектурой, tango и asado; за пределами мегаполиса — степи pampas, виноградники Mendoza, красные каньоны Salta и озёра Bariloche. Для первого визита важно понять масштаб: внутренние расстояния измеряются часами полёта, а не поездками на автобусе. Эта страница — отправная точка: от общей картины к конкретным темам путеводителя, направлениям и турам на платформе.",
  quickFacts: [
  ...
  geography: {
    ...
    body:
      "Страна вытянута с севера на юг более чем на 3 700 км. На западе — хребет Andes с Aconcagua (6 961 м). Центр занимают пampas — плодородные степи и аграрный пояс. На севере — субтропики Misiones и сухие каньоны северо-запада. Юг — Patagonia: степи, ледники, фьорды и ветреные горные хребты. Из‑за такой протяжённости «лучшее время» зависит от региона: в Patagonia лето — ноябрь–март, в Buenos Aires комфортны осень и весна, в Iguazú жарко круглый год с сезонными дождями.",
  },
  whyVisit: {
  ...
  regions: [
    ...
    },
    {
      ...
      title: "Iguazú",
      days: "2–3 дня",
      summary: "275 водопадов UNESCO, аргентинская и бrazilian стороны, джунгли Misiones.",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Ограниченно: у BA нет морских пляжей; Mar del Plata — сезон декабрь–мarch с толпами. Для качественного пляжа чаще смотрят Uruguay (Punta del Este) или Brazil.",
    },
    {
