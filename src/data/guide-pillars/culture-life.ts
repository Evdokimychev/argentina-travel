...
export const YAZYK_PILLAR: GuidePillarContent = {
  ...
  quickFacts: [
    { label: "Язык", value: "Испанский (rioplatense)" },
    { label: "Особенность", value: "Voseo, «sh» в ll/y" },
    { label: "Английский", value: "Частично в туристических зонах" },
    { label: "Must-know", value: "¿Cuánto cuesta? La cuenta, por favor" },
    { label: "Русский гид", value: "Авторские туры на платформе" },
    { label: "Курсы в BA", value: "Интенсивы от 1 недели" },
  ],
  sections: [
...
export const KULTURA_PILLAR: GuidePillarContent = {
  ...
  quickFacts: [
    { label: "Ужин", value: "С 21:00 — норма" },
    { label: "Mate", value: "Социальный ритуал, один круг" },
    { label: "Приветствие", value: "Поцелуй в щёку ×1" },
    { label: "Танго", value: "Milonga, cabeceo" },
    { label: "Asado", value: "Воскресный семейный ритуал" },
    { label: "Fútbol", value: "Boca, River, Racing, Independiente" },
  ],
  sections: [
...
export const ISTORIYA_PILLAR: GuidePillarContent = {
  ...
  quickFacts: [
    { label: "Независимость", value: "1816" },
    { label: "Perón / Evita", value: "1940–50-е, культурный след" },
    { label: "Демократия с", value: "1983" },
    { label: "Must-see", value: "Plaza de Mayo, Recoleta Cemetery" },
    { label: "Мемориал", value: "ESMA — Dirty War" },
    { label: "Иммиграция", value: "Италия, Испания — основа BA" },
  ],
  sections: [
...
export const KUHNYA_PILLAR: GuidePillarContent = {
  ...
  quickFacts: [
    { label: "Must-try", value: "Asado, empanada, dulce de leche" },
    { label: "Вино", value: "Malbec (Mendoza), Torrontés (Salta)" },
    { label: "Ужин", value: "С 21:00, бронь в топ parrilla" },
    { label: "Chimichurri", value: "Классический соус к мясу" },
    { label: "Helado", value: "Итальянское наследие" },
    { label: "Bodega tour", value: "Полдня–день в Mendoza" },
  ],
  sections: [
