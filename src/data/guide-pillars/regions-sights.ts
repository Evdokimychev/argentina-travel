  ...
  sections: [
    {
      ...
      widgetSlot: {
        id: "tourism-infographic-widget",
        label: "Инфографика",
        type: "tourism-infographic",
      },
    },
    { id: "turistskie-regiony-1", title: "Патагония и Огненная Земля", content: "Юг нельзя считать одним пунктом: Эль-Калафате нужен ради ледника Перито-Морено, Эль-Чальтен — ради пеших маршрутов, Барилоче — ради озёр и гор, Ушуайя — ради пролива Бигль и Огненной Земли. Выбирайте один кластер на короткую поездку и учитывайте сезонное расписание." },
    { id: "turistskie-regiony-2", title: "Буэнос-Айрес, центр и Куйо", content: "Буэнос-Айрес сочетает архитектуру, танго, музеи и гастрономию и обычно требует не меньше трёх дней. Мендоса добавляет винодельни и Анды, Кордова — колониальное наследие и горные посёлки. Эти направления проще связывать перелётом, чем длинным наземным переездом." },
    { id: "turistskie-regiony-3", title: "Северо-запад и Игуасу", content: "Сальта, Жужуй, Кафаяте и Кебрада-де-Умауака образуют маршрут по высокогорью, колониальным городам и андской кухне. Игуасу находится далеко на северо-востоке и требует отдельного перелёта. Не объединяйте оба севера только из-за названия: климат и логистика у них совершенно разные." },
    { id: "turistskie-regiony-4", title: "Как комбинировать регионы", content: "Для первой поездки разумна схема «Буэнос-Айрес плюс один большой природный регион». При двух неделях можно добавить вторую точку, если между ней есть удобный рейс. Сначала проверьте транспорт в конкретные даты, затем распределяйте ночи; один запасной день особенно полезен в Патагонии." },
    {
...
export const DOSTOPRIMECHATELNOSTI_PILLAR: GuidePillarContent = {
  ...
  sections: [
    { id: "dostoprimechatelnosti-1", title: "Природные символы", content: "Ледник Перито-Морено посещают по системе смотровых дорожек и с воды, водопады Игуасу — по нескольким контурам аргентинского парка, а Фицрой и Серро-Торре — по тропам из Эль-Чальтена. Полуостров Вальдес выбирают по сезону конкретных животных, а не как круглогодичный зоопарк." },
    { id: "dostoprimechatelnosti-2", title: "Города и культура", content: "В Буэнос-Айресе соедините площадь Мая, Сан-Тельмо, Реколету и один вечерний культурный опыт. Каминито посещайте днём и не ограничивайте им район Ла-Бока. В Кордове важен Иезуитский квартал, а в Сальте — колониальный центр и музеи высокогорной археологии." },
    { id: "dostoprimechatelnosti-3", title: "Как планировать посещение", content: "Для национальных парков сверяйте официальный режим, билеты, закрытия троп и погодные предупреждения. На популярные экскурсии в высокий сезон бронируйте заранее. Гид нужен не везде: на размеченной тропе он может быть необязателен, а на ледовой активности, лодке или сложном историческом маршруте — действительно полезен." },
    { id: "dostoprimechatelnosti-4", title: "Комбинированные маршруты", content: "На восемь–десять дней можно соединить Буэнос-Айрес, Эль-Калафате и Эль-Чальтен, если внутренние рейсы подходят по датам. Игуасу удобно комбинируется со столицей отдельным перелётом. Не добавляйте удалённую точку ради одной фотографии: учитывайте дорогу, заселение и запас на погоду." },
    { id: "dostoprimechatelnosti-5", title: "Музеи и места памяти", content: "Музей Эвиты раскрывает социальную и политическую историю перонизма, пространство памяти ESMA рассказывает о государственном терроре, MALBA показывает искусство Латинской Америки. Это разные типы посещения: проверяйте язык экскурсии, время входа и возрастную уместность материала для детей." },
  ],
  faq: SIGHTS_FAQ,
  blogLinks: [
