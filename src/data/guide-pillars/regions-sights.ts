...
export const POGODA_PILLAR: GuidePillarContent = {
  ...
  quickFacts: [
    { emoji: "☀️", label: "Патагония — лучший сезон", value: "Ноябрь–март" },
    { emoji: "🌡️", label: "BA — комфорт", value: "Март–май, сент–нояб" },
    { emoji: "🌧️", label: "Iguazú — меньше дождей", value: "Март–май, сент–нояб" },
    { emoji: "🏔️", label: "Salta / NOA", value: "Весна и осень" },
    { emoji: "📅", label: "Высокий сезон", value: "Дек–фев, июль (BA)" },
    { emoji: "💨", label: "Ветер Patagonia", value: "Круглый год, сильный" },
  ],
  sections: [
    {
