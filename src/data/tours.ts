...
export const baseTours: BaseTour[] = [
  ...
  },
  {
    ...
    description:
      "Буэнос-Айрес — «Париж Южной Америки». Прогуляйтесь по колоритному району Ла-Бока, посетите кладбище Реколета, где покоится Эва Перón (Perón), и насладитесь вечерним шоу танго в историческом milonga. Дегустация аргентинского стейка и вина Malbec завершит незабываемое знакомство с городом.",
    region: "Буэнос-Айрес",
    duration: "5 дней",
    priceUsd: 967,
    image:
  ...
  },
  {
    ...
    description:
      "Северо-запад Аргентины — регион контрастов: от колониальной Сальты до равнины Salinas Grandes на высоте 4000 метров. Каньон Quebrada de las Conchas с его красными скалами, винодельни Кафаяте и традиционные peñas с народной музыкой.",
    region: "Сальта",
    duration: "8 дней",
    priceUsd: 1457,
    image:
