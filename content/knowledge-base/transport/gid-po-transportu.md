...
type: transport
title: "Транспорт в Аргентине: полный тематический гид"
...
summary: "Навигационная точка входа по транспорту: как долететь из России, внутренние перелёты и расстояния, междугородние автобусы и поезда, аренда и покупка авто, права, городской транспорт по SUBE, трансфер из аэропорта. Собирает всю транспортную тему в одну карту — для туриста и релоканта."
status: published
site_ready: true
