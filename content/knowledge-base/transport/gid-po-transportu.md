...
aliases: ["всё про транспорт Аргентина", "как перемещаться", "перелёты автобусы поезда", "точка входа транспорт", "как добраться"]
...
recommendations:
  - "Турист: расстояния огромны — перемещения между регионами это внутренние перелёты, а не автобусы (см. [[vnutrennie-aviabilety]]). Релокант: для города достаточно SUBE."
...
Точка входа по транспорту — от перелёта из России до карты SUBE в городе.
...
- [[gid-po-dengam|Деньги в Аргентине]] · [[gid-po-dokumentam|Документы для въезда и переезда]] · [[gid-po-zhilyu|Жильё в Аргентине]] · [[gid-po-medicine|Медицина и страховка]] · [[gid-po-kulture|Культура Аргентины]]
