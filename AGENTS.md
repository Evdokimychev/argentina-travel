...
цель и конституция проекта; она заменяет короткую цель «продолжать улучшать
проект». Текущее доказанное состояние, приоритеты и риски ведутся в
`docs/project-governance/PROJECT_STATE.md`, `MASTER_PLAN.md`,
`ISSUE_LEDGER.csv`, `DECISION_LOG.md`, `RISK_REGISTER.md` и
`DEPENDENCY_GRAPH.md`.
...
1. **Анализ** — прочитай конституцию, связанные файлы, `docs/ai-first/`, правила `.cursor/rules/`
