...
-- Reapplying this layer makes legacy and newly created Supabase projects
-- converge on the same least-privilege grants.
...
begin
  ...
  foreach v_table in array array[
    ...
    'notification_preferences', 'organizer_applications', 'organizer_inbox_reads',
