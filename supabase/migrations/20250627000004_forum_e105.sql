...
values
  (
    ...
    'f1050002-0002-4002-8002-000000000001',
    null,
    'Палermo делится на несколько барrio: Soho, Hollywood, Chico. Для первых недель удобны районы с метро и кафе поблизости — **Palermo Soho** или **Recoleta** рядом. Карту супermarketов и Subte лучше сохранить офлайн.',
    now() - interval '2 days'
  ),
  (
