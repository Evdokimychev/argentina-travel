...
Сформирован: 2026-07-20T00:04:52.515Z

## Исходное состояние

- Проверено сущностей базы знаний: **689**.
- Критических: **398**; высокий приоритет: **67**; средний: **0**.
...
- `avellaneda` — Avellaneda; non_russian_title, non_russian_summary
- `aventura-en-la-patagonia-andina` — Aventura en la Патагония andina; non_russian_summary
...
- `camino-de-la-costa` — shore road; non_russian_title, non_russian_summary
...
- `carnaval-de-humahuaca` — Humahuaca Carnival; non_russian_title, non_russian_summary
- `carnaval-en-corrientes` — Carnival in Corrientes; non_russian_title, non_russian_summary
...
- `comarca-andina-del-paralelo-42` — Comarca Andina del Paralelo 42; non_russian_title, non_russian_summary
- `cordoba-de-las-campanas` — Córdoba with Bells; non_russian_title, non_russian_summary
- `corredor-de-la-puna` — Puna Route; non_russian_title, non_russian_summary
- `corredor-del-viento` — Corredor del Viento; non_russian_title, non_russian_summary
- `cosquin` — Cosquín; non_russian_title, non_russian_summary
- `costa-atlantica-de-la-provincia-de-buenos-aires` — Costa Atlántica de la provincia de Буэнос-Айрес; non_russian_summary
- `costanera-de-corrientes` — coastal promenade in Corrientes; non_russian_title, non_russian_summary
- `costanera-de-formosa` — Formosa coastal promenade; non_russian_title, non_russian_summary
- `cruce-de-los-andes` — Andean crossing; non_russian_title, non_russian_summary
- `cuesta-del-viento` — Cuesta del Viento; non_russian_title, non_russian_summary
- `cueva-de-las-manos` — Куэва-де-лас-Манос (Пещера рук); not_publication_ready
