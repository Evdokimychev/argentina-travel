...
| `/blog`, `/guide`, `/baza-znaniy` | Читаемые статьи, FAQ | Иммиграция по умолчанию скрыта из меню/SEO |
| `/shop`, `/forum` | Не в навигации; прямой URL может быть 404 после promote | Пустые оболочки не рекламируем |
