...
Детерминированный digest снимка: `8420628a007931b2`.

## Покрытие

- Страницы App Router: **157**.
- Route handlers: **312**.
- Metadata routes: **1**.
- Middleware matchers: **1**.
- Статически обнаруженные взаимодействия в достижимом от страниц UI: **2299**.
...
- cms: **142** маршрутов со статическим сигналом.
...
- static_data: **277** маршрутов со статическим сигналом.
...
- youtravel: **42** маршрутов со статическим сигналом.
