...
Детерминированный digest снимка: `659ea080447d6c53`.

## Покрытие

- Страницы App Router: **160**.
- Route handlers: **314**.
- Metadata routes: **1**.
- Middleware matchers: **1**.
- Статически обнаруженные взаимодействия в достижимом от страниц UI: **2456**.
- Строк route → component/data: **475**.
...
- cms: **156** маршрутов со статическим сигналом.
- external_http: **375** маршрутов со статическим сигналом.
...
- static_data: **276** маршрутов со статическим сигналом.
- supabase: **359** маршрутов со статическим сигналом.
