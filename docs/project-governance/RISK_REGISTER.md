...
| R-005 | Dirty worktree or feature ancestry causes mixed release/loss of owner changes | high | high | 24 unrelated entries remain; candidate branch has earlier feature history | scoped commits, no reset/delete, controlled cherry-pick/release integration | before stage/deploy / engineering | active |
...
| R-011 | Safety guide cold SSR creates an apparent permanent loader | medium | medium | first response 7.9–8.6 s; final content succeeds | profile server timing/data dependencies before isolated optimization | p95 route latency / engineering | open P2 |
