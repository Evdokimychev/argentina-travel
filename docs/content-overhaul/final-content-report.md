...
- Проходит единый публичный quality gate: **232**.
- Намеренно архивировано с сохранением исходника и редиректом: **448**.
- Осталось заблокировано качеством вне архива: **11**.
- Существенно переписано или расширено в рабочем diff: **0**; всего редакционно изменённых опубликованных материалов: **14**.
- Создано новых материалов: **0**; физически удалено: **0**.
- Чувствительные публичные материалы со строгой claim-level проверкой: **80/80**.
...
- Проверено **909** уникальных внешних URL опубликованной базы; битых публичных ссылок: **0**.
