...
- Проходит единый публичный quality gate: **216**.
- Намеренно архивировано с сохранением исходника и редиректом: **449**.
- Осталось заблокировано качеством вне архива: **26**.
- Существенно переписано или расширено в рабочем diff: **0**; всего редакционно изменённых опубликованных материалов: **0**.
- Создано новых материалов: **0**; физически удалено: **0**.
- Чувствительные публичные материалы со строгой claim-level проверкой: **64/64**.
- Непокрытых обязательных тематических кластеров: **2/38**.

## Тематическое покрытие

- Требует закрытия: **Банки, карты, переводы и Mercado Pago** — expected one of: gid-po-dengam;banki-i-perevody.
- Требует закрытия: **Работа, удалённая занятость и бизнес** — expected one of: rabota-i-poisk-raboty;udalyonnaya-rabota-i-oplata;otkrytie-biznesa.
