...
- Проходит единый публичный quality gate: **237**.
- Намеренно архивировано с сохранением исходника и редиректом: **448**.
- Осталось заблокировано качеством вне архива: **6**.
- Существенно переписано или расширено в рабочем diff: **1**; всего редакционно изменённых опубликованных материалов: **9**.
- Создано новых материалов: **0**; физически удалено: **0**.
- Чувствительные публичные материалы со строгой claim-level проверкой: **85/85**.
